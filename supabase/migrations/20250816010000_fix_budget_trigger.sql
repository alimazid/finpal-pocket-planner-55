-- Fix the budget spent calculation trigger to work with user_preferences and new period logic

CREATE OR REPLACE FUNCTION public.update_budget_spent_v5()
RETURNS TRIGGER
LANGUAGE plpgsql
SECURITY DEFINER
SET search_path TO ''
...
CREATE TRIGGER update_budget_spent_trigger
    ...
    FOR EACH ROW
    EXECUTE FUNCTION public.update_budget_spent_v5();